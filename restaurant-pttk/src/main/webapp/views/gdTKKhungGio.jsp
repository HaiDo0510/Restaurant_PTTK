...
<body>
	<section id="container">
        ...
        *********************************************************************************************************************************************************** -->
		...
		<%
		List<HoaDon> lHoaDons =(List<HoaDon>) session.getAttribute("listHD");
			...
			<section class="wrapper">
				<div class="row">
					<div style="padding: 20px 20px 0px 20px;">
						<h2 style="text-align: center;">Danh sách hóa đơn</h2>
						<div style="float: left">
							<span><h3>Khung giờ: <%=session.getAttribute("kg") %></h3></span> <span><h4>Ngày:
									<%=ngayStart %> -> <%=ngayEnd %></h4></span>
						</div>
						<div class="top-menu" style="float: right">
							<ul class="nav pull-right top-menu">
								<li><a class="logout" href="gdTKLuongKhachTB.jsp">Quay
										lại</a></li>
							</ul>
						</div>
					</div>
					...
					<div style="padding: 20px">
						<table id="customers">
							...
							<tr>
								...
								<td><%=h.getNgay() %></td>
								<td>34</td>
								<td><%=formatter.format(h.getTongtien()) %> vnđ</td>
							</tr>
							<%} %>
						</table>
